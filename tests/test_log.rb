...
RSpec.describe :log do
  it 'can log a message' do
    dotty_run_script '((:debug "hello world friend"))' do |_dotty, _sin, _sout, serr, _proc|
  ...
  it 'can log at different levels' do
    ...
    dotty_run_script script do |_dotty, _sin, _sout, serr, _proc|
  ...
  it 'can printf log arguments' do
    dotty_run_script '((:debug "the value is %03d" 5))' do |_dotty, _sin, _sout, serr, _proc|
