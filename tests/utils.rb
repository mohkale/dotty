...
class Dotty
  ...
  def install_dir; self.class.install_dir; end
  def config_dir; self.class.config_dir; end
  def dotty_bin; self.class.dotty_bin; end
  ...
  def self.dotty_bin
    if @dotty_bin == nil
      @dotty_bin = File.join(File.dirname(__dir__), "dotty")
    end
    @dotty_bin
  end
end
